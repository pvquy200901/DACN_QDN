...
namespace BackEnd_Football.APIs
{
    public class MyStadium
    {
        ...
        public async Task<bool> createAsync(string name, string address, string contact, string isDelete, string isFinish, DateTime createdTime)
        {
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(address) || string.IsNullOrEmpty(contact) || string.IsNullOrEmpty(isDelete) || string.IsNullOrEmpty(isDelete) || string.IsNullOrEmpty(isFinish))
            {
                return false;
            }
            using (DataContext context = new DataContext())
            {
                ...
                stadium.isDelete = false;
                stadium.isFinish = false;
                stadium.createdTime = createdTime;
        ...
        public async Task<bool> editAsync(string name, string address, string contact, string isDelete, string isFinish, DateTime createdTime)
        {
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(address) || string.IsNullOrEmpty(contact) || string.IsNullOrEmpty(isDelete) || string.IsNullOrEmpty(isDelete) || string.IsNullOrEmpty(isFinish))
            {
                return false;
