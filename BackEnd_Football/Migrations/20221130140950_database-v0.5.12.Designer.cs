...
namespace BackEnd_Football.Migrations
{
    ...
    [Migration("20221130140950_database-v0.5.12")]
    partial class databasev0512
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd_Football.Models.SqlUser", b =>
                {
                    b.HasOne("BackEnd_Football.Models.SqlState", "SqlState")
                        .WithMany()
                        .HasForeignKey("SqlStateID");

                    b.HasOne("BackEnd_Football.Models.SqlTeam", "SqlTeam")
                        .WithMany("user")
                        .HasForeignKey("SqlTeamid");

                    b.Navigation("SqlState");
