        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shortDes = table.Column<string>(type: "text", nullable: false),
                    createdTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    images = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    code = table.Column<string>(type: "text", nullable: false),
                    orderTime = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SqlStateID = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodDrink_stateID",
                table: "FoodDrink",
                column: "stateID");

            migrationBuilder.CreateIndex(
                name: "IX_FoodDrink_userSystemID",
                table: "FoodDrink",
                column: "userSystemID");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOrderFD_SqlOrderFDid",
                table: "ItemOrderFD",
                column: "SqlOrderFDid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderFD_orderStadiumid",
                table: "OrderFD",
                column: "orderStadiumid");

            migrationBuilder.CreateIndex(
                name: "IX_OrderFD_stateOrderID",
                table: "OrderFD",
                column: "stateOrderID");

            migrationBuilder.CreateIndex(
                name: "IX_OrderFD_userManagerOrderID",
                table: "OrderFD",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ItemOrderFD_OrderFD_SqlOrderFDid",
                table: "ItemOrderFD",
                column: "SqlOrderFDid",
                principalTable: "OrderFD",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_OrderFD_OrderStadium_orderStadiumid",
                table: "OrderFD",
                column: "orderStadiumid",
